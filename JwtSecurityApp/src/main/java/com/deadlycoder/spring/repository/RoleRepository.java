package com.deadlycoder.spring.repository;

import java.util.Optional; // Import Optional for handling optional values

import com.deadlycoder.spring.models.EmployeeRole; // Import EmployeeRole enumeration
import com.deadlycoder.spring.models.Role; // Import Role model
