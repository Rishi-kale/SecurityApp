package com.deadlycoder.spring.security.services;

import com.deadlycoder.spring.models.User; // Import User model
import com.deadlycoder.spring.repository.UserRepository; // Import UserRepository for user database operations
